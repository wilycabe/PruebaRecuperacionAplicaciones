...
<html lang="en">
    ...
    <body>
        ...
        <section>
            <h1 id="h1_inicio">Bienvenido</h1>
            <h2 id="h2_inicio">Aplicacion web para la administración de bibliotecas</h2>
            <img src="https://cloudfront-us-east-1.images.arcpublishing.com/eluniverso/NPCMI7NVIRGLBJXCI3VYOEWGPE.jpg">
        </section>
